...
const mumbai = {
  ...
  rpcUrls: {
    public: { http: ['https://polygon-mumbai.g.alchemy.com/v2/n7HfrIcluZLlgIJ9Z-2yyNYIZC-pK0h1'] },
    default: { http: ['https://polygon-mumbai.g.alchemy.com/v2/n7HfrIcluZLlgIJ9Z-2yyNYIZC-pK0h1'] },
  },
  blockExplorers: {
    default: { name: 'Bitfinity Block Explorer', url: 'https://explorer.bitfinity.network/' },
    etherscan: { name: 'Bitfinity Block Explorer', url: 'https://explorer.bitfinity.network/' },
...
const { chains, publicClient } = configureChains(
  [mainnet, bitfinity,mumbai, hardhat],
